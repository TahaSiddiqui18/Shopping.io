...
export const Cards = () => {
    ...
    return (
        <>
            <div className="sm:text-center px-4 text-left mt-20">
                <h1 className="text-3xl font-bold" style={{ fontFamily: "Clash Display" }}>
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 mt-10">
                <div className="p-4 rounded flex-1">
                    ...
                    <h3 className="font-bold text-lg" style={{ fontFamily: "Clash Display" }}>Next day as standard</h3><br />
                    <p style={{ fontFamily: "Satoshi" }}>Order before 3pm and get your order
                ...
                <div className="p-4 rounded flex-1">
                    ...
                    <h3 className="font-bold text-lg" style={{ fontFamily: "Clash Display" }}>Made by true artisans</h3><br />
                    <p style={{ fontFamily: "Satoshi" }}>Handmade crafted goods made with
                ...
                <div className="p-4 rounded flex-1">
                    ...
                    <h3 className="font-bold text-lg" style={{ fontFamily: "Clash Display" }}>Unbeatable prices</h3><br />
                    <p style={{ fontFamily: "Satoshi" }}>For our materials and quality you won’t find better prices anywhere</p>
                </div>
                <div className="p-4 rounded flex-1">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" fill="white" style={{ mixBlendMode: "multiply" }} />
                    ...
                    <h3 className="font-bold text-lg" style={{ fontFamily: "Clash Display" }}>Recycled packaging</h3><br />
                    <p style={{ fontFamily: "Satoshi" }}>We use 100% recycled packaging to ensure our footprint is manageable</p>
                </div>
            </div>
            <div>
                <h1 className="p-10 font-bold text-4xl" style={{ fontFamily: "Clash Display" }}>
                    New ceramics
                </h1>
            </div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white p-4">
                    <img src="/images/Right Image.png" alt="The Dandy Chair" className="w-full h-auto md:h-96 mb-4" />
                ...
                <div className="bg-white p-4 ">
                    <img src="/images/Photo (1).png" alt="Rustic Vase Set" className="w-full h-auto md:h-96 mb-4" />
                ...
                <div className="bg-white p-4 ">
                    <img src="/images/Photo (2).png" alt="The Silky Vase" className="w-full h-auto md:h-96 mb-4" />
                ...
                <div className="bg-white p-4 ">
                    <img src="/images/Photo (3).png" alt="The Lucy Lamp" className="w-full h-auto md:h-96 mb-4" />
            ...
            <div className="text-center md:text-left mt-4 m-10">
            ...
            <div>
                <h1 className="p-10 font-bold text-4xl text-[#2A254B]" style={{ fontFamily: "Clash Display" }}>
                    Our popular products
                </h1>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div className="bg-white p-4">
                    <img src="/images/Large.png" alt="The Dandy Chair" className="w-full h-96 mb-4" />
                    <h3 className="text-lg font-bold mb-2" style={{ fontFamily: "Clash Display" }}>The Poplar suede sofa</h3>
                    <p className="text-sm" style={{ fontFamily: "Satoshi" }}>£980</p>
                </div>
                <div className="bg-white p-4 ">
                    <img src="/images/Right Image.png" alt="Rustic Vase Set" className="w-full h-96 mb-4" />
                    <h3 className="text-lg font-bold mb-2" style={{ fontFamily: "Clash Display" }}>The Dandy chair</h3>
                    <p className="text-sm" style={{ fontFamily: "Satoshi" }}>£250</p>
                </div>
                <div className="bg-white p-4 ">
                    <img src="/images/Parent.png" alt="The Silky Vase" className="w-full h-96 mb-4" />
                    <h3 className="text-lg font-bold mb-2" style={{ fontFamily: "Clash Display" }}>The Dandy chair</h3>
                    <p className="text-sm" style={{ fontFamily: "Satoshi" }}>£250</p>
                </div>
            </div>
