        ...
        <>
            ...
            <div className="grid grid-cols-2 p-4">
                ...
                <div className="container mx-auto px-6 flex justify-end space-x-6">
                    <a href="#" className="text-gray-500 hover:text-black hidden sm:block text-center">
                        About us
                    </a>
                    <a href="#" className="text-gray-500 hover:text-black hidden sm:block">
                        Contact
                    </a>
                    <a href="#" className="text-gray-500 hover:text-black hidden sm:block">
                        Blog
                    ...
                    <nav>
                        <span className="flex sm:hidden pl-2">
                            <GiHamburgerMenu />
                        </span>
                    </nav>
                </div>
