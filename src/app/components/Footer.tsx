...
export const Footer = () => {
    return (
        <>
            <footer className="text-[rgb(255,255,255)] bg-[#2A254B] body-font">
                <div className="px-5 py-24 mx-auto">
                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 md:text-left text-center order-first">
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4">
                            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3" style={{ fontFamily: "Clash Display" }}>Menu</h2>
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>New arrivals</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Best sellers</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Recently viewed</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Popular this week</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>All products</a>
                                </li>
                            </nav>
                        </div>
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4">
                            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3" style={{ fontFamily: "Clash Display" }}>Categories</h2>
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Crockery</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Furniture</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Homeware</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Plant pots</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Chairs</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Crockery</a>
                                </li>
                        ...
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4 col-span-2 md:col-span-2 lg:col-span-1 text-left pl-12">
                            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3" style={{ fontFamily: "Clash Display" }}>Our company</h2>
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>About us</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Vacancies</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Contact us</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Privacy</a>
                                </li>
                                <li>
                                    <a className="text-gray-400 hover:text-white" style={{ fontFamily: "Satoshi" }}>Returns policy</a>
                                </li>
                            </nav>
                        </div>
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4 col-span-3 lg:col-span-1">
                            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3" style={{ fontFamily: "Clash Display" }}>Join our mailing list</h2>
                            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start"><br /><br />
                                <form className="flex text-[#F9F9F9] mx-auto justify-center">
                                    <input type="email" placeholder="your@email.com" className="flex border border-gray-300 p-2" />
                                    <button type="submit" className="bg-[#FFFFFF] text-[#2A254B] font-bold py-2 px-4" style={{ fontFamily: "Clash Display" }}>Sign Up</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-[#2A254B] bg-opacity-75">
                    <div className="container px-5 py-6 sm:mx-auto flex sm:items-center sm:flex-row flex-col">
                        <a className="flex title-font font-medium sm:items-center md:justify-start text-white">
                        </a>
                        <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4" style={{ fontFamily: "Satoshi" }}>Copyright 2022 Avion LTD
                        </p>
                        <span className=" hidden sm:inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start gap-5">
