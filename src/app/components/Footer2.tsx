        ...
        <>
            <footer className="text-[rgb(255,255,255)] bg-[#2A254B] body-font">
                <div className="px-5 py-24 mx-auto">
                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 md:text-left text-center order-first">
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4">
                            <h1 className="text-2xl font-extrabold text-white mb-3" style={{ fontFamily: "Clash Display" }}>Avion</h1>
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>21 New York Street</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>New York City</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>United States of America</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>432 34</a>
                                </li>
                            </nav>
                        </div>
                        <span className="sm:flex gap-5 flex-col px-2">
                            <h2>Social Licks</h2>
                            <div className="grid md:grid-cols-6 grid-cols-3 py-5 gap-7 sm:gap-0  ">
                        ...
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4 hidden sm:block">
                            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3" style={{ fontFamily: "Clash Display" }}>Menu</h2>
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>New arrivals</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Best sellers</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Recently viewed</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Popular this week</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>All products</a>
                                </li>
                            </nav>
                        </div>
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Crockery</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Furniture</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Homeware</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Plant pots</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Chairs</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Crockery</a>
                                </li>
                        ...
                        <div className="xl:w-1/4 md:w-1/2 w-full px-4 col-span-1 md:col-span-2 lg:col-span-1 text-left pl-12">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>About us</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Vacancies</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Contact us</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Privacy</a>
                                </li>
                                <li>
                                    <a className="text-[#FFFFFF]" style={{ fontFamily: "Satoshi" }}>Returns policy</a>
                                </li>
                            </nav>
                        </div>
                    </div>
                ...
                <div className="bg-[#2A254B] bg-opacity-75">
                    <div className="container px-5 py-6 sm:mx-auto flex sm:items-center sm:flex-row flex-col">
                        ...
                        <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4 text-center" style={{ fontFamily: "Satoshi" }}>Copyright 2022 Avion LTD
                        </p>
                    </div>
                </div>
            </footer>
